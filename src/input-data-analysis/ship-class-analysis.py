...
from src.shiptypes import create_ship_dataframe
...
cutter = [(0, 2000), (5000, 10e3), (10e3, 30e3), (30e3, 60e3), (60e3, 145e3), (145e3, 10000e3)]
...
df = df.rename(columns={"IMO":"Count", "NEWCLASS": "Shipclass", "GT Class": "Gross tonnage"})

plt.figure(figsize=(10, 6))
ax = sns.barplot(x="Gross tonnage",
            y="Count",
            hue="Shipclass",
            data=df)
ax.set_ylabel("Number of Ships")
#ax.set_xlabel("Gross tonnage", size=14)
ax.set_xticklabels(["<" + str((int(i[1]))) for i in cutter[0:-1]] + [">145000"])
...
plt.figure(figsize=(10, 6))
ax = sns.histplot(data=ships[["NEWCLASS", "BUILT"]], x="BUILT", hue="NEWCLASS", multiple="stack")
leg = ax.get_legend()
leg.set_title("Type")
